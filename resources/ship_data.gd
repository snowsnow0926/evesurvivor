...
static func get_all_ships() -> Array[ShipData]:
	return [_frigate(), _cruiser(), _battlecruiser(), _battleship(), _dreadnought(), _titan()]
...
static func get_ship(ship_id: ShipID) -> ShipData:
	match ship_id:
		ShipID.FRIGATE: return _frigate()
		ShipID.CRUISER: return _cruiser()
		ShipID.BATTLECRUISER: return _battlecruiser()
		ShipID.BATTLESHIP: return _battleship()
		ShipID.DREADNOUGHT: return _dreadnought()
		ShipID.TITAN: return _titan()
	return _frigate()
